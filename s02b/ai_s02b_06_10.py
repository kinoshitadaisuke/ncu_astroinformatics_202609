...
#
# Time-stamp: <2026/09/24 10:31:25 (UT+08:00) daisuke>
#
...
def main ():
    ...
    descr  = 'visualisation of star-to-star matching result'
    ...
    norm1 \
        ...
        ( stretch=astropy.visualization.HistEqStretch (image1_aligned) )
